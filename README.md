...
```javascript
import { add, add3, assert, div, identity, mul, muladd, neg, scale, sub } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float64-base@v0.2.0-esm/index.mjs';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float64-base@v0.2.0-esm/index.mjs';
